...
## Scope and boundary (fixed by P7-I00, )
...
### Phase 7 citation resolution + coverage gap (P7-I06)
...
### Phase 7 provisional → final key migration (P7-I05)
...
### Phase 7 source verification run (P7-I02, live arXiv API)
...
### Phase 6 Markdown-first run (P6-I01, offline fixture)
...
- **Note (post-approval).** The provisional `tbd…` keys above were
  ...
  . The historical SHA-256s above still refer to the
...
- **Human verification:** approved by human reviewer `evya1` at
  `T22:59:51+02:00`. The approval is recorded in
...
### Phase 9 LaTeX assembly pipeline integration (P9-I01..P9-I14)
...
- **Inputs:** workpack at
  `/Desktop/agentic_publishing_phase9_adapted_current_repo/`;
...
### Phase 10 PDF build pipeline (P10-I01, P10-I02)
...
### Phase 11 ValidatorService (P11-I01..P11-I06)
...
### Phase 12 tests for ValidatorService (P12-I03, P12-I04)
